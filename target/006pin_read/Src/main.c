...
{
//--->D12
		int32_t volatile *pClockControlRegister = (int32_t*) 0x40023830;
		int32_t volatile *pGpiodModeRegister = (int32_t*) 0x40020C00;
		int32_t volatile *pGpiodOutputDataRegister = (int32_t*) 0x40020C14;
//---->A0

		int32_t volatile *pGpioAModeRegister = (int32_t*) 0x40020000;
		int32_t volatile *pGpioAInputRegister = (int32_t*) 0x40020010;
	...
	// ----->PIN0 AS INPUT
	 ...
	 // ------>   Simdi IO A0.pini reada çek (gpioa input data register)
